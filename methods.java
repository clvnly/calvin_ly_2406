public int create_user(String username, String password, int creditcard, String home_address);
...
public double calc_utilRate(int emp_id, double hoursWorked, double billableHours);